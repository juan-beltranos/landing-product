...
async function obtenerProductoPorID(productoID) {
    ...
    try {
        const response = await fetch('https://ms-public-api.rocketfy.com/rocketfy/api/v1/products', {
            headers: {
        ...
        if (producto) {
            printHTML(producto); // Aquí puedes mostrar el producto en el DOM
        } else {
...
function printHTML(producto) {
    ...
    <section class="colors-section">
        ...
        <button class="order-btn" id="comprarcontraentrega">Lo quiero!</button>
    </section>
